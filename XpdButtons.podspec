...
Pod::Spec.new do |s|
  s.name             = 'XpdButtons'
  s.version          = '0.1.0'
  s.summary          = 'A short description of XpdButtons.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/XpdButtons'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ravi Prakash' => 'raviprakash.xpd54@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/XpdButtons.git', :tag => s.version.to_s }
